...
class NGAFID_DatasetManager():
    ...
    def __init__(self, config, name="2021_IAAI_C28", scaler=None, ):
        self.config = config
        pass
    ...
    def create_folded_datasets(self):
        ...
        for i in range(self.config.NFOLD):
            self.folded_datasets.append(self.ngafid_dataframe_to_dataset(df[df.split == i], truncate_last_timesteps = 4096))
